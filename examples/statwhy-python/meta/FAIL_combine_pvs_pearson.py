...
# Publication bias: inappropriate use of Pearson's method for combining 3 p-values.
...
def ex_combine_pvs_pearson(pv1 : real, pv2 : real, pv3 : real, fml: formula) -> real :
    ...
    #@      (* If analysts wish to detect an excess of small p-values, they should apply Fisher's method. *) \
    ...
    #@         Then this will not satisfy a precondition for Pearson's method *) \
    #@      length pvs > 0 /\ \
    #@      pvalues pvs /\ \
...
res = ex_combine_pvs_pearson(pv1, pv2, pv3, fml)
print("incorrect ex_combine_pvs_pearson p-value : %f" % res)
# p-value : 0.032363
