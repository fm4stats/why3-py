...
template_dict['combine_pvs_MudholkarGeorge'] = r'''
from statwhy import Nil, Cons, real
from statwhy import formula, Disj, sit
...
# Executes Mudholkar-George's method for combining p-values.
def ex_combine_pvs_MudholkarGeorge({{pv_fargs}}, fml: formula) -> real :
    #@  requires \
    #@    let pvs  = {{ml_pv_list}} in \
    #@    pvalues pvs /\ \
    #@    let d : dataset real = { data = pvs; scale = Interval } in \
